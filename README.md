...
|------------|-------------|------------------|
| `general` | General | Broad agricultural queries, basic farm management |
...
The feeding data is stored in a MongoDB document with the following structure:
```javascript
{
  <agentType>: <Your Data>
}
...
Data feeding and updating works similarly to updating data in a MongoDB document. Each time you feed data to the Deltaton platform, you will receive a response containing all your stored data in the following format as an example:
```javascript
{
  success: true,
  message: 'Feed data received successfully',
  data: {
    'myfarm-6929b996627f55b365431319': {
      temperature: 27,
      humidity: 14,
